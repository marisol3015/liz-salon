...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2> <font color="white">Crear servicio de Peinados</font> </h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
                    <form  method="post" action="{{ route('peinados.store') }}" data-parsley-validate class="form-horizontal form-label-left" >
